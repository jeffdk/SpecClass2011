...
@timestamp def "Wed Aug 24 00:18:54 2011"
@r0 off
@link r0 to g0
@r0 type above
@r0 linestyle 1
...
@    s0 comment "L2(sqrt(dFError^2))[FD_O4ConvErr.dat]"
@    s0 legend  "L2(sqrt(dFError^2))[FD_O4ConvErr.dat]"
@    s1 hidden false
@    s1 type xy
@    s1 symbol 0
...
@    s1 comment "L2(sqrt(dFError^2))[FD_O6ConvErr.dat]"
@    s1 legend  "L2(sqrt(dFError^2))[FD_O6ConvErr.dat]"
@    s2 hidden false
@    s2 type xy
@    s2 symbol 0
...
@    s2 comment "L2(sqrt(dFError^2))[SpectralConvErr.dat]"
@    s2 legend  "L2(sqrt(dFError^2))[SpectralConvErr.dat]"
@target G0.S0
@type xy
8 0.0018407835
9 0.0011687885
